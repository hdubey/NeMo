...
try:
    ...
    logging.warning(
        "nemo.collections.asr.parts.utils.aligner_utils not found in this NeMo build. "
        "ForceAligner will not be available."
    )
    add_t_start_end_to_utt_obj = get_batch_variables = viterbi_decoding = None
